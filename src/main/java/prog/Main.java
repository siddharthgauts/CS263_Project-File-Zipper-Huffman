...
public class Main extends JFrame implements ActionListener {
	...
	public JPanel createContentPane() {
		...
		redLabel = new JLabel("File size selected: ");
		redLabel.setLocation(43, 0);
		redLabel.setSize(150, 30);
		redLabel.setHorizontalAlignment(0);
		titlePanel.add(redLabel);

		blueLabel = new JLabel(" File size after Zip/Unzip:");
		...
		ZH = new JButton("ZIP with Huff");
		ZH.setLocation(0, 0);
		ZH.setSize(120, 30);
		ZH.addActionListener(this);
		buttonPanel.add(ZH);

		UH = new JButton("UNZIP Huff");
